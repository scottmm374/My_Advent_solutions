...
def main():
    ...
    while rounds <= 1000:
        ...
        monkey_one, monkey_two, monkey_zero, m_one = check_monkey_one(monkey_one, monkey_two, monkey_zero, m_one)
        monkey_two, monkey_one, monkey_three, m_two = check_monkey_two(monkey_two, monkey_one, monkey_three, m_two)
        monkey_three, monkey_zero, monkey_one, m_three = check_monkey_three(monkey_three, monkey_zero, monkey_one, m_three)

        # monkey_four, monkey_two, monkey_six, m_four = process_monkey(monkey_four, monkey_two, monkey_six, m_four)
        # monkey_five, monkey_one, monkey_four, m_five = process_monkey(monkey_five, monkey_one, monkey_four, m_five)
        # monkey_six, monkey_zero, monkey_two, m_six = process_monkey(monkey_six, monkey_zero, monkey_two, m_six)
        # monkey_seven, monkey_three, monkey_five, m_seven = process_monkey(monkey_seven, monkey_three, monkey_five, m_seven)
...
def check_monkey_zero(arr_0, arr_1, arr_2, count, memo={}):
    ...
    key = (tuple(temp_0), tuple(temp_3), tuple(temp_7), count)
    if key in memo:
        return memo[key]
    ...
    while len(temp_0) > 0:
        ...
        if new % 3 == 0:
            ...
            temp_7.append(new)
    result = (temp_0, temp_3, temp_7, m_zero)
    memo[key] = result
    return result


def check_monkey_one(arr_0, arr_1, arr_2, count, memo={}):
    ...
    key = (tuple(temp_1), tuple(temp_4), tuple(temp_6), count)
    if key in memo:
        return memo[key]
    ...
    result = (temp_1, temp_4, temp_6, m_one)
    memo[key] = result
    return result
...
def check_monkey_two(arr_0, arr_1, arr_2, count, memo={}):
    ...
    key = (tuple(temp_2), tuple(temp_0), tuple(temp_7), count)
    if key in memo:
        return memo[key]
    ...
    result = (temp_2, temp_0, temp_7, m_two)
    memo[key] = result
    return result


def check_monkey_three(arr_0, arr_1, arr_2, count, memo={}):
    ...
    key = (tuple(temp_3), tuple(temp_1), tuple(temp_5), count)
    if key in memo:
        return memo[key]
    ...
    result = (temp_3, temp_1, temp_5, m_three)
    memo[key] = result
    return result


# def check_monkey_four(arr_0, arr_1, arr_2, count, memo={}):
...
#     key = (tuple(temp_4), tuple(temp_2), tuple(temp_6), count)
#     if key in memo:
#         return memo[key]
...
#     result = (temp_4, temp_2, temp_6, m_four)
#     memo[key] = result
#     return result

# def check_monkey_five(arr_0, arr_1, arr_2, count, memo={}):
...
#     key = (tuple(temp_5), tuple(temp_1), tuple(temp_4), count)
#     if key in memo:
#         return memo[key]
...
#         else:
#             temp_4.append(new)
#     result = (temp_5, temp_1, temp_4, m_five)
#     memo[key] = result
#     return result

# def check_monkey_six(arr_0, arr_1, arr_2, count, memo={}):
...
#     key = (tuple(temp_6), tuple(temp_0), tuple(temp_2), count)
#     if key in memo:
#         return memo[key]
...
#     result = (temp_6, temp_0, temp_2, m_six)
#     memo[key] = result
#     return result

# def check_monkey_seven(arr_0, arr_1, arr_2, count, memo={}):
...
#     key = (tuple(temp_7), tuple(temp_3), tuple(temp_5), count)
#     if key in memo:
#         return memo[key]
...
#     result = (temp_7, temp_3, temp_5, m_seven)
#     memo[key] = result
#     return result
